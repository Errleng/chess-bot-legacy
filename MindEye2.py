...
SAVE_PATH = "C:/Users/aisae/Documents/GitHub/pythonBoots/Screenshots/"
    ...
    while True:
        ...
        for row in lengthArray:
            for column in widthArray:
                ...
                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BPawnB.PNG', image)
                if max_Val < 0.8:
                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BPawnW.PNG', image)
                    if max_Val < 0.8:
                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WPawnB.PNG', image)
                        if max_Val < 0.8:
                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WPawnW.PNG', image)
                            if max_Val < 0.8:
                                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BRookB.PNG', image)
                                if max_Val < 0.8:
                                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BRookW.PNG', image)
                                    if max_Val < 0.8:
                                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WRookB.PNG', image)
                                        if max_Val < 0.8:
                                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WRookW.PNG', image)
                                            if max_Val < 0.8:
                                                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BBishopB.PNG', image)
                                                if max_Val < 0.8:
                                                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BBishopW.PNG', image)
                                                    if max_Val < 0.8:
                                                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WBishopB.PNG', image)
                                                        if max_Val < 0.8:
                                                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WBishopW.PNG', image)
                                                            if max_Val < 0.8:
                                                                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BKnightB.PNG', image)
                                                                if max_Val < 0.8:
                                                                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BKnightW.PNG', image)
                                                                    if max_Val < 0.8:
                                                                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WKnightB.PNG', image)
                                                                        if max_Val < 0.8:
                                                                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WKnightW.PNG', image)
                                                                            if max_Val < 0.8:
                                                                                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BKingB.PNG',image)
                                                                                if max_Val < 0.8:
                                                                                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BKingW.PNG',image)
                                                                                    if max_Val < 0.8:
                                                                                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WKingB.PNG',image)
                                                                                        if max_Val < 0.8:
                                                                                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WKingW.PNG',image)
                                                                                            if max_Val < 0.8:
                                                                                                rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BQueenB.PNG',image)
                                                                                                if max_Val < 0.8:
                                                                                                    rgbTemplateMatch(SAVE_PATH + 'BlackPieces/BQueenW.PNG',image)
                                                                                                    if max_Val < 0.9:
                                                                                                        rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WQueenB.PNG',image)
                                                                                                        if max_Val < 0.7:
                                                                                                            rgbTemplateMatch(SAVE_PATH + 'WhitePieces/WQueenW.PNG',image)
                                                                                                            if max_Val < 0.7:
                                                                                                                if MTnum <= 6:
                                                                                                                    slashCounter += 1
                                                                                                                    MTnum += 1

...
def main():
    ...
    if not new_board:
        player = input("Enter the player's side: ")
        ...
        difficulty = 0 # How strong the program plays
    ...
    if not new_board and difficulty == 0:
        if ENGINE_NAME == "Rybkav2.3.2a.mp.x64.exe":
            ...
            print("Set Rybka's ELO to", elo, "and set MultiPV to 3")
    ...
    if new_board:
        ...
        while True:
            ...
            # print("Moving side:", moving_side)

            if moving_side == "b" and player.lower() == "white":
                continue
            if moving_side == "w" and player.lower() == "black":
                continue
